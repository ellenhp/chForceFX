 ...
 *  process begins.
 */
const USB_Descriptor_Device_t PROGMEM joystickDeviceDescriptor =
{
 ...
 */
const USB_Descriptor_Configuration_t PROGMEM joystickConfigurationDescriptor =
{
	.Config =
		{
                                    ...
                                    const void** const DescriptorAddress)
{
	...
	{
		case DTYPE_Device:
			Address = &joystickDeviceDescriptor;
			Size = sizeof(USB_Descriptor_Device_t);
			break;
		case DTYPE_Configuration:
			Address = &joystickConfigurationDescriptor;
		...
		case DTYPE_String:
			...
			break;
		case DTYPE_HID:
			Address = &joystickConfigurationDescriptor.HID_JoystickHID;
